...
public class InlineResponse200 {
  ...
  private List<CONSUMPTIONLOG> data = new ArrayList<CONSUMPTIONLOG>();

  public static final String SERIALIZED_NAME_TOTAL = "total";
  @SerializedName(SERIALIZED_NAME_TOTAL)
  private InlineResponse200Total total = null;

  public InlineResponse200 data(List<CONSUMPTIONLOG> data) {
    this.data = data;
    return this;
  }

  public InlineResponse200 addDataItem(CONSUMPTIONLOG dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<CONSUMPTIONLOG>();
    }
  ...
  **/
  ...
  public void setData(List<CONSUMPTIONLOG> data) {
    this.data = data;
  }
