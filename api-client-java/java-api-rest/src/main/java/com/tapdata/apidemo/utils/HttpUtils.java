...
public class HttpUtils {
    ...
    public static Map<String, Object> httpPatch(String url, Map<String, Object> body, Map<String, String> extraHeaders, Integer timeout) throws ServiceException {
    ...
    public static Map<String, Object> httpDelete(String url, Map<String, ?> variables, Map<String, String> extraHeaders, Integer timeout) throws ServiceException {
        SimpleClientHttpRequestFactory requestFactory = new SimpleClientHttpRequestFactory();
        requestFactory.setConnectTimeout(timeout * 1000);
        requestFactory.setReadTimeout(timeout * 1000);
        RestTemplate restTemplate = new RestTemplate(requestFactory);
